...
![](p8105_hw6_sjk2254_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
see that the distribution for the log_betas is slightly skewed to the
right while the distribution for the r^2 is slightly skewed to the left.
...
We are 95% confident that the true r^2 value is between 0.8895 and
0.9405.
...
```
    ...
    ##         2.5%        97.5% 
    ## -0.009711504  0.007633974

We are 95% confident that the true log(beta_1\*beta_2) is between
-0.0097 and 0.0076.
...
![](p8105_hw6_sjk2254_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
![](p8105_hw6_sjk2254_files/figure-gfm/unnamed-chunk-22-1.png)<!-- -->
